  ...
  <template>
    ...
    <div class="zero-click-sso__status admin-detail">
      ...
      {{#if @controller.siteSettings.zero_click_sso_enabled}}
        {{#if @controller.siteSettings.zero_click_sso_enabled_for_noisy_providers}}
          <p style="background-color: darkgreen; color: white; padding: 8px 12px;">
            <em>Enabled for all providers</em>
          </p>
        {{else}}
          <p style="background-color: darkgoldenrod; color: white; padding: 8px 12px;">
